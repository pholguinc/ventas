<aside id="sidebar-wrapper">
    <div class="sidebar-brand">
      <a href="{{ route('admin.index') }}"> <img alt="image" src="{{ url('storage/img/logo.png') }}" class="header-logo" /> <span
    ...
    <ul class="sidebar-menu">
      ...
      <li class="dropdown active">
        <a href="{{ route('admin.categories') }}" class="nav-link"><i data-feather="monitor"></i><span>Dashboard</span></a>
      </li>
      <li class="dropdown">
        <a href="#" class="menu-toggle nav-link has-dropdown"><i
            data-feather="briefcase"></i><span>Administración</span></a>
        <ul class="dropdown-menu">
          <li><a class="nav-link" href="{{ route('admin.roles') }}">Roles</a></li>
          <li><a class="nav-link" href="{{ route('admin.permissions') }}">Permisos</a></li>
          <li><a class="nav-link" href="{{ route('admin.users') }}">Usuarios</a></li>
        </ul>
      </li>

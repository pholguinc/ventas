        ...
        <div class="col-sm-12 col-md-6">
            <div class="form-group">
                ...
                <div class="input-group">
                    ...
                    <select wire:model.lazy="document_id" class="form-control">
        ...
        <div class="col-sm-12 col-md-6">
            <div class="form-group">
                ...
                <div class="input-group">
                    ...
                    <input type="text" wire:model.lazy="numDocument" class="form-control" placeholder="ej: 20422521263">
                    <div class="input-group-preprend ml-2">
                        <a wire:click="searchCustomer" class="input-group-text bg-dark" style="text-decoration: none;">
        ...
        <div class="col-sm-12">
            <div class="form-group">
                ...
                <div class="input-group">
                    ...
                    <input type="text" wire:model.lazy="name" class="form-control" placeholder="ej: Nombre del cliente">
                </div>

    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
                    ...
                    <div class="col-sm-12">
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" wire:model.lazy="permissionName" class="form-control" placeholder="ej: Nombre del proveedor">
                            </div>
            ...
            <div class="modal-footer bg-whitesmoke br">
                ...
                <div>
                    @if($selected_id < 1) <button type="button" wire:click.prevent="CreatePermission()" class="btn btn-primary close-modal">
                        <div class="spinner">
                            <span>Guardar</span>
                        ...
                        @else
                        <button type="button" wire:click.prevent="UpdatePermission()" class="btn btn-primary close-modal">
                            <div class="spinner">
